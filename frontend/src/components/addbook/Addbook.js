...
export const Addbook = () => {
  ...
  const createBook = async (userInput) => {
    await axios
    .post(process.env.REACT_APP_API_URL + 'book/newBook', userInput)
    .then((res) => {
    ...
    <section className="lightbrownbg">
      <div className='container text-center p-5'>
        ...
        <h2 className="m-4 fw-bold">Add a book</h2>
          ...
          <input className="form-control w-50" type="text" name="author" onChange={onChange}/>


          <label className="mt-3 mb-1">Description</label>
          <input className="form-control w-50" type="text" name="description" onChange={onChange} />


          <label className="mt-3 mb-1" name="genre">Genre</label>
          <select className="form-select w-50 text-center" name="genre" value={userInput.genre} onChange={onChange} >
          ...
          <input className="form-control w-50" type="text" name="condition" onChange={onChange} />

          <label className="mt-3 mb-1 ">Release Date</label>
          <input className="form-control w-50 text-center" type="date" name="release" onChange={onChange} />

          <input className="form-control w-50 text-center" type="text" name="owner"  onChange={onChange} />
